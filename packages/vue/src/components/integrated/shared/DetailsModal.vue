...
import { getChainName } from '@paraport/core'
...
<template>
  <Dialog v-model:open="isOpen">
    <DialogContent :position>
      ...
      <div v-if="selectedQuote" class="pp-flex pp-flex-col">
        ...
        <div class="pp-rounded-lg pp-bg-surface-grey pp-py-4 pp-px-[14px] pp-flex pp-flex-col pp-gap-2 pp-mt-[18px]">
          <p class="pp-text-sm pp-text-text pp-capitalize">
            {{ t('detailsModal.whatIsAutoteleport.title') }}
          </p>
